...
LANGUAGE_DATA = {
    ...
    "he": ("פתח תיקיית שמירות", "תיקיית השמירות נفتחה.", "תיקיית השמירה לא נמצאה. ודא ששיחקת במשחק לפחות פעם אחת."),
    ...
    "hr": ("Otvori mapu sa spremljenim igrama", "Mapa sa spremljenim igrama je otvorena.", "Mapa za spremanje nije pronađena. Provjerite jeste li igrali igru barem jednom."),
    ...
    "te": ("సేవ్స్ ఫోల్డర్ తెరవండి", "సేవ్స్ ఫోల్డర్ తెరవబడింది", "సేవ్ ఫోల్డర్ కనుగొనబడలేదు. మీరు కనీసం ఒక్కసารైనా ఆట ఆడి ఉన్నారని నిర్ధారించుకోండి."),
    "kn": ("ಉಳಿಸಿದ ಫೋಲ್ಡರ್ ತೆರೆಯಿರಿ", "ಉಳಿಸಿದ ಫೋಲ್ಡರ್ ತೆರೆಯಲಾಗಿದೆ", "ಉಳಿಸಿದ ಫೋಲ್ಡರ್ ಕಂಡುಬந்தಿಲ್ಲ. ನೀವು ಕನಿಷ್ಠ ಒಮ್ಮೆಯಾದರೂ ಆಟವನ್ನು ಆಡಿದ್ದೀರಿ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ."),
    "ml": ("സേవ్സ് ഫോൾഡർ തുറക്കുക", "സేవ్സ് ഫോൾഡர் തുറന്നു", "സేవ్ ఫోల్డర్ കണ്ടെത്തിയില്ല. നിങ്ങൾ കുറഞ്ഞത് ഒരു തവണയെങ്കിലും ഗെയിം കളിച്ചിട്ടുണ്ടെന്ന് ഉറപ്പാക്കുക."),
    "mr": ("सेव्ही फोल्डर उघडा", "सेव्ह फोल्डर उघडले", "सेव्ह फोल्डर आढळले नाही. तुम्ही किमान एकदा तरी गेम खेळला असल्याची खात्री करा."),
    "gu": ("સેવ્સ ફોલ્ડر ખોલો", "સેવ્સ ફોલ્ડર ખોલવામાં આવ્યું", "સેવ ફોલ્ડર મળ્યું નથી. ખાતરી કરો કે તમે ઓછામાં ઓછું એકવાર રમત રમ્યા છો."),
    "pa": ("ਸੇਵਜ਼ ਫੋਲਡਰ ਖੋਲ੍ਹੋ", "ਸේਵਜ਼ ਫੋਲਡਰ ਖੋਲ੍ਹਿਆ گیا", "ਸੇਵ ਫੋਲਡਰ ਨਹੀਂ ਮਿਲਿਆ। ਯਕੀਨੀ ਬਣਾਓ ਕਿ ਤੁਸੀਂ ਘੱਟੋ-ਘੱਟ ਇੱਕ ਵਾਰ ਗੇਮ ਖੇਡੀ ਹੈ।"),
    ...
    "et": ("Ava salvestuskaust", "Salvestuskaust avatud", "Salvestuskausta ei leitud. Veenduge, et olete mängu väهمalt korra mänginud."),
...
for lang_code in TRANSLATIONS:
    if lang_code in LANGUAGE_DATA:
        ...
        # Fallback to English for any unknown codes (like 'tl' if it's not in our map yet, wait I put it)
...
print("translations.py has been fully localized for ALL 50+ languages specifically.")
